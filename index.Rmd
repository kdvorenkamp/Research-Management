...
p
```
So, I'm not sure what to do with the R markdown commentary here. Obviously, there is more work and formatting to be done, but at least I now know that it's possible to code a Gantt chart in R, and there are several packages that can help me get the style I want. I would like to pursue this further, as I think it ultimately can help me organize my research and task management into visual aids that can help keep me on task.
